...
ActiveRecord::Schema.define(version: 20131123065532) do
  ...
  create_table "locations", force: true do |t|
    ...
    t.string   "request_domain", default: ""
  end

  add_index "locations", ["user_usid"], name: "index_locations_on_user_usid", using: :btree
  ...
  create_table "sites", force: true do |t|
    ...
    t.string   "title_online",            default: ""
    t.string   "title_offline",           default: ""
    ...
    t.string   "offline_welcome_message", default: ""
    t.integer  "auto_open_timeout",       default: 3
    t.string   "user_prefix",             default: "guest"
  end
