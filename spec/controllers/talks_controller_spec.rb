...
describe TalksController do
  ...
  let(:valid_attributes) { { "site_id" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved talk as @talk" do
        ...
        post :create, {:talk => { "site_id" => "invalid value" }}, valid_session
        assigns(:talk).should be_a_new(Talk)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested talk" do
        ...
        Talk.any_instance.should_receive(:update).with({ "site_id" => "MyString" })
        put :update, {:id => talk.to_param, :talk => { "site_id" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the talk as @talk" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Talk.any_instance.stub(:save).and_return(false)
        put :update, {:id => talk.to_param, :talk => { "site_id" => "invalid value" }}, valid_session
        assigns(:talk).should eq(talk)
      end
