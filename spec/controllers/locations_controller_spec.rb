  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested location" do
        ...
        Location.any_instance.should_receive(:update).with({ "username" => "MyString" })
        put :update, {:id => location.to_param, :location => { "username" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the location as @location" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Location.any_instance.stub(:save).and_return(false)
        put :update, {:id => location.to_param, :location => { "username" => "invalid value" }}, valid_session
        assigns(:location).should eq(location)
      end
