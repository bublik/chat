json.cache! [@site, I18n.locale], expires_in: 15.minutes do
  json.extract! @site, :btn_title, :name, :domain, :color, :side, :position, :collect_stats, :title_online, :title_offline, :auto_open, :auto_open_timeout, :offline_welcome_message, :enabled
