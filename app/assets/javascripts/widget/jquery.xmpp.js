    ...
    $.xmpp ={
        ...
        */
        setPresence: function(type, callback){
            var msg;
            if(type == null)
                msg = "<presence xmlns='jabber:client'><show>chat</show><status>Online</status><priority>0</priority></presence>";
            else
                msg = "<presence xmlns='jabber:client'><show>"+type+"</show><status>Online</status><priority>0</priority></presence>";
            this.sendCommand(msg,callback);
        },
